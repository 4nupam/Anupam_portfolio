      ...
      <main className="px-10  md:px-20 lg:px-40">
        ...
        <section className="grid mt-12 grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4">
          ...
          <div class=" max-w-sm p-6 bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
            ...
            <a href="#">
              <h5 class="mb-2 text-2xl font-semibold tracking-tight text-gray-900 dark:text-white">Freelance</h5>
            </a>
            ...
            <a href="https://www.linkedin.com/in/anupam-upadhyay-504a1b208/" class="inline-flex font-medium items-center text-blue-600 hover:underline">
              More About Me
